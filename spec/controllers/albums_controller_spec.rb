...
describe AlbumsController do
  ...
  describe "GET index" do
    it "assigns all albums as @albums" do
      Album.stub(:find).with(:all).and_return([mock_album])
      get :index
  ...
  describe "GET show" do
    it "assigns the requested album as @album" do
      Album.stub(:find).with("37").and_return(mock_album)
      get :show, :id => "37"
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      it "assigns a newly created album as @album" do
        Album.stub(:new).with({'these' => 'params'}).and_return(mock_album(:save => true))
